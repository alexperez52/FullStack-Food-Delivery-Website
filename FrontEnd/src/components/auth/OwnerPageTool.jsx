    ...
    return (
      <div>
          <button onClick={this.createClicked}>
           {this.state.stat ? <label>Edit Restaurant</label> : <label>Create Restaurant</label>}
          </button>
          <button onClick={this.addClicked}>
            add items
          </button>
          <button onClick={this.viewClicked}>
            view items
          </button>

          <hr>
          </hr>
          <Route exact path ='/owner/restaurants' component={CreateRestaurantTool}/>

          <Route path ='/owner/restaurants/add' component={AddItemsTool} />

          <hr />

          <Route exact path = '/owner/restaurants/add/view' component ={DisplayItemsTool} />
      </div>
    );
  }
}
